// ignore_for_file: must_be_immutable, unused_label, avoid_unnecessary_containers
...
class LandScapeLoginScreen extends StatelessWidget {
  ...
  LandScapeLoginScreen({super.key});
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Padding(
              padding: const EdgeInsets.only(left: 16, right: 20, top: 0),
              child: Row(
                children: [
                  const Expanded(
                      child: Image(
